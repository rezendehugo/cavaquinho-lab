...
export default function PracticePage() {
  ...
  return <section className="panel practice-page fretboard-page" aria-labelledby="practice-title">
    <header className="fretboard-hero"><div><p className="eyebrow">Treino guiado</p><h2 id="practice-title">Prática no cavaquinho</h2><p>Pratique escalas por posições exatas ou acompanhe as formas de uma sequência.</p></div></header>
    ...
    {mode === 'scale' ? <ScalePracticePanel key="scale" /> : <SequencePracticePanel key="sequence" />}
  </section>;
}
